    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Edit sale</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('all.sale')}}">All sale</a>
                            </li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Edit sale</a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="form-validate" class="form form-horizontal" method="POST" action="{{route('update.sale',$sale->id)}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1 form-group">
                                                ...
                                                <select class="form-select" name="customer_id" id="customer_id">
                                                    ...
                                                    <option value="{{ $item->id }}" {{$sale->customer_id == $item->id?'selected' : ''}}>{{ Illuminate\Support\Str::ucfirst($item->name) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1 form-group">
                                                ...
                                                <input type="date" class="form-control" value="{{$sale->sale_date}}" name="sale_date" id="sale_date">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="currency" {{$sale->currency == 'iqd'?'checked' : ''}} id="iqd" value="iqd" checked>
                                                    <label class="form-check-label" for="iqd">IQD</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="currency" {{$sale->currency == 'usd'?'checked' : ''}} id="usd" value="usd" >
                                        ...
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1 form-group">
                                                ...
                                                <input type="hidden" name="exist_attach_file" value="{{$sale->attach_file}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 mt-3">
                                        <div class="mb-1">
                                            ...
                                            <textarea class="form-control" name="notes" id="notes" placeholder="Additional Notes">{{ $sale->notes }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    @if ($sale->pay_due != 0 && $sale->pay_status != 'paid')
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-xl-6 col-md-6 col-12">
                                                <div class="mb-1 form-group">
