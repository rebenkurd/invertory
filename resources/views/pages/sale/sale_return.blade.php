                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card-header ">
                                <h3>All sale</h3>
                                <a href="{{route('add.sale')}}" class="btn btn-primary waves-effect"><i data-feather="plus"></i> Add sale</a>
                            </div>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(-93px, 23px);">
                                                        <a class="dropdown-item" href="{{route('details.sale',$item->id)}}">
                                                            <span data-feather="eye"class="me-50"></span>
                                                            <span>View</span>
                                                        </a>
                                                        <a class="dropdown-item" href="{{route('edit.sale',$item->id)}}">
                                                            <span data-feather="edit-2"class="me-50"></span>
                                                            <span>Edit</span>
                                                        </a>
                                                        <a class="dropdown-item"  href="{{route('delete.sale',$item->id)}}" id="row-delete">
                                                ...
                                                <div class="modal text-start" id="pay-now{{ $key }}" tabindex="-1" aria-labelledby="payment" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg ">
                                                        <form action="{{ route('sale.paynow') }}" id="pay-now-form" method="POST">
                                                            @csrf
                                                            <input type="hidden" name="sale_id" value="{{ $item->id }}" id="sale_id">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-xl-12 col-md-12 col-12">
                                                                            ...
                                                                            @php
                                                                                $payments=App\Models\Payment::where('sale_id',$item->id)->get();
                                                                            @endphp
