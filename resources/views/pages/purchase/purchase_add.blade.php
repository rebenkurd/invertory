                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('add.purchase')}}">Add Purchase</a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="form-validate" class="form form-horizontal" method="POST" action="{{route('store.purchase')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4 mt-3 offset-2">
                                        <div class="mb-1">
                                            <h3>Total Purchase:
                                            <span class="fw-bolder" id="total_purchase">0.00</span>
