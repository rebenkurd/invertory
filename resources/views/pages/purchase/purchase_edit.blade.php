    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Edit Purchase</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('all.purchase')}}">All Purchase</a>
                            </li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Edit Purchase</a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="form-validate" class="form form-horizontal" method="POST" action="{{route('update.purchase',$purchase->id)}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1 form-group">
                                                ...
                                                <select class="form-select" name="supplier_id" id="supplier_id">
                                                    ...
                                                    <option value="{{ $item->id }}" {{$purchase->supplier_id == $item->id?'selected' : ''}}>{{ Illuminate\Support\Str::ucfirst($item->name) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1 form-group">
                                                <label class="form-label form-group" for="purchase_date">Purchase Date</label>
                                                <input type="date" class="form-control" value="{{$purchase->purchase_date}}" name="purchase_date" id="purchase_date">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="currency" {{$purchase->currency == 'iqd'?'checked' : ''}} id="iqd" value="iqd" checked>
                                                    <label class="form-check-label" for="iqd">IQD</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="currency" {{$purchase->currency == 'usd'?'checked' : ''}} id="usd" value="usd" >
                                        ...
                                        <div class="col-xl-6 col-md-6 col-12">
                                            <div class="mb-1 form-group">
                                                ...
                                                <input type="hidden" name="exist_attach_file" value="{{$purchase->attach_file}}">
                                ...
                                <div class="row">
                                            ...
                                            <table class="table table-bordered" id="items_table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="tr_{{$product->product_id}}">
                                                        <input type="hidden" id="{{$product->product_id}}" name="pr_id[]" value="{{$product->id}}">
                                                            <td><input type="text" class="form-control" name="pr_name[]" disabled value="{{$product->pr_name}}"></td>
                                                            <td>
                                                                <div class="input-group bootstrap-touchspin">
                                                                    ...
                                                                    <input type="text"  class="touchspin form-control" id="qty" value="{{$item->quantity}}" name="pr_qty[]">
                                                                    <input type="hidden" value="{{$item->quantity}}" name="exist_qty[]">
                                                                    <span class="input-group-btn bootstrap-touchspin-injected">
                                                            ...
                                                            <td><input type="text" class="form-control" id="total_amount" name="total_amount[]" value="{{$item->amount}}"></td>
                                                            <td><input type="text" class="form-control" name="selling_price" value="{{$product->selling_price}}"></td>
                                    ...
                                    <div class="col-6 mt-3">
                                        <div class="mb-1">
                                            ...
                                            <textarea class="form-control" name="notes" id="notes" placeholder="Additional Notes">{{ $purchase->notes }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    @if ($purchase->pay_due != 0 && $purchase->pay_status != 'paid')
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-xl-6 col-md-6 col-12">
                                                <div class="mb-1 form-group">
                                    ...
                                    <div class="alert alert-success p-1">
                                        <p>
                                            Ohh!Good You Already Paid Thank You
                                        </p>
                                    </div>
                                    @endif
...
<script>
    ...
    function updateGrandTotal() {
        ...
        $("#total_purchase").text(grandTotal.toFixed(2));
        $("#total_purchase_input").val(grandTotal.toFixed(2));
    }
